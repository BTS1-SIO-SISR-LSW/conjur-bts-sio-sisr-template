...
## Concepts clés à faire ressortir
- **host** : identité machine ;
- **layer** : groupe logique de machines ;
- **variable** : secret protégé ;
- **permit** : droits accordés ;
- **grant** : rattachement d'identités à un groupe.

## Pour transformer ce dépôt en template GitHub
1. créer un dépôt GitHub et y pousser ce contenu ;
2. cocher **Template repository** dans les paramètres ;
3. distribuer le modèle via GitHub Classroom.
